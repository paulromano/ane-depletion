...
TODO: Discuss missing FPY~\cite{fensin2015pne}.
...
was created and made available for users at \url{https://openmc.org}. This chain
includes 223 nuclides and has adjusted decay branching ratios for some nuclides
to preserve the accuracy of nuclide production rates. \Cref{fig:chains} shows
which nuclides are included in each of the depletion chains.
\begin{figure}
  \centering
...
using the \texttt{openmc.deplete} module as well as Serpent 2.1.31 on two simple
problems. The first problem is a pressurized water reactor (PWR) pincell and the
second problem is a single assembly of a sodium-cooled fast reactor (SFR). These
problems were selected to cover both thermal and fast neutron spectra.
...
\Cref{fig:pwr-actinides-casl} shows the differences in actinide concentrations
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{figures/pwr/pwr_actinides_full.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{figures/pwr/pwr_actinides_casl.pdf}
  \caption{Relative difference in actinide concetrations between OpenMC and
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{figures/pwr/pwr_fp_full_average.pdf}
...
\Cref{fig:pwr-fp-full-thermal} shows the predicted fission product concetrations
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{figures/pwr/pwr_fp_full_thermal.pdf}
  \caption{Relative difference in fission product concetrations between OpenMC
  and Serpent for the PWR pincell model at 5, 12.5, 30, and 50 MWd/kg using the
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{figures/pwr/pwr_fp_casl_average.pdf}
  \caption{Relative difference in fission product concetrations between OpenMC
  and Serpent for the PWR pincell model at 5, 12.5, 30, and 50 MWd/kg using the
...
\begin{figure}[H]
  \centering
  \includegraphics[width=4in]{figures/pwr/pwr_fp_casl_thermal.pdf}
  \caption{Relative difference in fission product concetrations between OpenMC
  and Serpent for the PWR pincell model at 5, 12.5, 30, and 50 MWd/kg using the
...
\Cref{fig:sfr-keff} shows the difference between $k_\text{eff}$ over time
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_actinides_full.pdf}
    \caption{Full depletion chain}
    \label{fig:sfr-actinides-full}
  \end{subfigure}
  \hspace{0.05\textwidth}
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_actinides_casl.pdf}
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_actinides_full_nop.pdf}
    \caption{Full depletion chain}
    \label{fig:sfr-actinides-full-nop}
  \end{subfigure}
  \hspace{0.05\textwidth}
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_actinides_casl_nop.pdf}
    \caption{CASL depletion chain}
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_fp_full_average.pdf}
    \caption{Full depletion chain}
  \end{subfigure}
  \hspace{0.05\textwidth}
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_fp_casl_average.pdf}
    \caption{CASL depletion chain}
  \end{subfigure}
  \caption{Relative difference in fission product concetrations between OpenMC
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_fp_full_average_nop.pdf}
    \caption{Full depletion chain}
  \end{subfigure}
  \hspace{0.05\textwidth}
  \begin{subfigure}[t]{0.45\textwidth}
    \includegraphics[width=\textwidth]{figures/sfr/sfr_fp_casl_average_nop.pdf}
    \caption{CASL depletion chain}
  \end{subfigure}
  \caption{Relative difference in fission product concetrations between OpenMC
  and Serpent for the SFR assembly model at 80, 180, 260, and 360 days with
...
Discuss temperature dependence and probability tables in SFR model.
